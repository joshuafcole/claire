...
var exports = module.exports = function(window) {
  ...
  function enterContext(context) {
    var ctxKeyword = new cljs.core.Keyword(null, context, context);
    lt.objs.context.in_BANG_(null, ctxKeyword);
  }
  ...
  function exitContext(context) {
    var ctxKeyword = new cljs.core.Keyword(null, context, context);
    lt.objs.context.out_BANG_(null, ctxKeyword);
  }
  ...
  function open(filepath) {
    var openPath = new cljs.core.Keyword(null, 'open-path', 'open-path');
